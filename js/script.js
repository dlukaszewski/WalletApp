...
const deletaAllBtn = document.querySelector(".delete-all");
...
const newTransaction = () => {
	...
	// Poniżej zapis operatora warunkoowego w celach cwiczeniowych
	inputAmount.value > 0
...
const deleteTransaction = id => {
	...
	const transactionAmount = parseFloat(
		transactionToDelete.childNodes[2].outerText
	);
...
deletaAllBtn.addEventListener("click", deletaAllTransactions);
